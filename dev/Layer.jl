using Lux: AbstractLuxLayer, FromFluxAdaptor, StatefulLuxLayer
using SciMLSensitivity: InterpolatingAdjoint, ZygoteVJP, EnzymeVJP
...
function (n::NeuralODE)(x, p, st)
  ...
  return (
    solve(prob, n.args...;
      sensealg=InterpolatingAdjoint(; autojacvec=EnzymeVJP()), n.kwargs...),
    model.st)
end
